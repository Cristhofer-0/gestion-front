...
export default function Login() {
  ...
  const [testimonios, setTestimonios] = useState<
    { id: string; texto: string; autor: string; rating: number }[]
  >([])
  ...
  // Carrusel automático solo si hay testimonios
  useEffect(() => {
                  ...
                  <footer className="border-t border-gray-700 pt-4">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-gray-400"><StarRating rating={testimonios[testimonioActual].rating} /></div>
                      </div>
                    </div>
                  </footer>
                </blockquote>
